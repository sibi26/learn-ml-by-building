...
- Source: **[Scikit-learn California housing dataset](https://scikit-learn.org/stable/modules/generated/sklearn.datasets.fetch_california_housing.html)**- Why This Dataset: Strong income–price correlation makes it perfect for demonstrating optimization concepts while being complex enough to show real challenges

---

**Previous**: [← Lecture 3: Linear Regression](03-linear.qmd) | **Next**: [Lecture 5: Probabilistic Classification](05-probclass.qmd)
